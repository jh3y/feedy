(function() { angular.module('feedy.Services', []);
...
angular.module("feedy").run(["$templateCache", function($templateCache) {$templateCache.put("directives/Feed.html","<ul class=\"feed bd--grey rd--border\"></ul>");
